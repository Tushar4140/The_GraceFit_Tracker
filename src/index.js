...
document.addEventListener("DOMContentLoaded", async() => {
      ...
      <div class="flex-1 overflow-y-auto flex flex-col items-center w-full">
        <h1 class="font-bold text-2xl mt-3 mb-5">GraceFit Tracker</h1>
        <div class="relative w-full flex flex-row justify-center items-center">
          <img
            src="./img/Dumbbell exercise-bro.svg"
...
// Add this code at the beginning of your index.js
document.getElementById('openWorkoutGenerator').addEventListener('click', () => {
  // Show the modal when the button is clicked
  document.getElementById('workoutModal').style.display = 'block';
});
document.getElementById('openWorkoutGenerator').addEventListener('click', async () => {
  // Open the personalized workout generation project via the server
  fetch('http://localhost:3001/openWorkoutGenerator')
